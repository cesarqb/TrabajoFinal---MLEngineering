...
En el navegador, inicie sesión en Github. Luego, vaya al enlace del proyecto original (https://github.com/cesarqb/TrabajoFinal---MLEngineering) y dé click al botón "Fork". Esto copiará todo el proyecto en su usuario de Github.
